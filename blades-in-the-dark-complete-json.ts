...
export const bladesInTheDarkCompleteJson: TabletopRpgGameData = {
  metadata: {
    ...
    tags: ['fantasy', 'heist', 'crew', 'urban', 'supernatural'],
    minimumAge: 13,
    playerCount: {
      min: 2,
      max: 6,
  ...
  i18n: {
    ...
    terminology: {
      ...
      'advancement.add_special_ability': {
        en: 'Add Special Ability',
        default: 'Add Special Ability',
      },
      ...
      'step.choose_special_ability': {
        en: 'Choose Special Ability',
        default: 'Choose Special Ability',
      },
      ...
      'challenge.supernatural_forces': {
        en: 'Supernatural Forces',
        default: 'Supernatural Forces',
      },
    ...
    strings: {
      ...
      'ability.alchemist.description': {
        ...
        default:
          'When you invent or craft a creation with alchemicals, take +1 result level to your roll. You begin each score with light load if you choose not to take a standard loadout. You create 2 alchemicals from the list below (with their load included) at the start of each score.',
      },
      'ability.infiltrator.description': {
        ...
        default:
          'You are not affected by quality or Tier when you bypass security measures. When you survey to gather information, you get +1 effect.',
      },
      'ability.rook_s_gambit.description': {
        ...
        default:
          'When you attempt to seduce or manipulate someone, you may always ask one of the following questions as a free inquiry (even on a failure): What does your character wish I would do? What does your character fear most? How could I get your character to __?',
      },
      ...
      'heritage.akoros.description': {
        ...
        default:
          'The largest land in the Imperium, your homeland is covered in verdant fields, rolling hills, and robust mining operations',
      },
      'heritage.dagger_isles.description': {
        en: 'Your heritage is from the nearby archipelago, dominated by scavengers and pirates',
        default:
          'Your heritage is from the nearby archipelago, dominated by scavengers and pirates',
      },
      'heritage.iruvia.description': {
        en: 'Your heritage is from the desert cities to the south, where war and rebellion are common',
        default:
          'Your heritage is from the desert cities to the south, where war and rebellion are common',
      },
      'heritage.severos.description': {
        ...
        default:
          'Your heritage is from the distant reaches of the northern lands, where the old ways still hold sway',
      },
      ...
      'heritage.tycheros.description': {
        ...
        default:
          'Your heritage is from the remote islands far to the east, known for their martial arts and metal-working',
      },
      ...
      'vice.stupor.description': {
        ...
        default:
          'You seek oblivion in the abuse of drugs, drink to excess, getting beaten up, etc.',
      },
      ...
      'advancement.playbook_xp.description': {
        ...
        default:
          "At the end of each session, mark 1 xp if you addressed a challenge with your playbook's preferred approach",
      },
      'advancement.attributes_xp.description': {
        ...
        default:
          'At the end of each session, mark 1 xp if you expressed your beliefs, drives, heritage, or background',
      },
      'advancement.struggle_xp.description': {
        ...
        default:
          'At the end of each session, mark 1 xp if you struggled with issues from your vice or traumas',
      },
  ...
  characterTemplates: [
    ...
    },
    {
      ...
      startingAbilities: ['sharpshooter'],
      specialAbilities: [
        'sharpshooter',
        'focused',
        'ghost_hunter',
    ...
    },
    {
      ...
      startingAbilities: ['rook_s_gambit'],
      specialAbilities: [
        'rook_s_gambit',
        'cloak_and_dagger',
        'ghost_voice',
  ...
  groupTypes: [
    {
      ...
      startingUpgrades: ['fine_killing_tools', 'assassin_rigging'],
    ...
    },
    {
      ...
      startingUpgrades: ['fine_weapons', 'thug_rigging'],
    ...
    },
    {
      ...
      startingUpgrades: ['ritual_altar_and_shrine', 'ancient_obelisk'],
    ...
    },
    {
      ...
      startingUpgrades: ['drug_den', 'hawker_rigging'],
    ...
    },
    {
      ...
      startingUpgrades: ['thief_rigging', 'underground_maps_and_passkeys'],
    ...
    },
    {
      ...
      startingUpgrades: ['boat_house', 'smuggler_rigging'],
    ...
    locations: [
      {
        ...
        traits: ['industrial', 'working_class', 'polluted'],
        securityLevel: 2,
        notableLocationKeys: [
          'location.barrowcleft.gaddoc_rail_station',
          'location.barrowcleft.the_docks',
      ...
      },
      {
        ...
        traits: ['wealthy', 'noble', 'heavily_guarded'],
        securityLevel: 4,
        notableLocationKeys: [
          'location.brightstone.scurlock_manor',
          'location.brightstone.bowmore_bridge',
      ...
      },
      {
        ...
        traits: ['commercial', 'middle_class', 'bureaucratic'],
        securityLevel: 3,
        notableLocationKeys: [
          'location.charterhall.city_council_chambers',
          'location.charterhall.doskvol_academy',
      ...
      },
      {
        ...
        traits: ['criminal', 'poor', 'dangerous'],
        securityLevel: 1,
        notableLocationKeys: [
          'location.crows_foot.the_bucket',
          'location.crows_foot.gym',
      ...
      },
      {
        ...
        traits: ['industrial', 'poor', 'polluted'],
        securityLevel: 1,
        notableLocationKeys: [
          'location.dunslough.the_soot',
          'location.dunslough.bellweather_crematorium',
      ...
      },
      {
        ...
        traits: ['noble', 'political', 'ancient'],
        securityLevel: 4,
        notableLocationKeys: [
          'location.six_towers.whitecrown',
          'location.six_towers.towers',
