          ...
          <div className="text-center space-y-8">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12">
              <Card>
                ...
                <CardContent>
                  <p className="text-neutral-400">
                    Build characters using any Forged in the Dark ruleset.
                    Upload custom rules or use community-created content.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-neutral-400">
                    Organize characters across multiple games and campaigns.
                    Track advancement, stress, and relationships.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-neutral-400">
                    Share characters with GMs, clone builds for new games,
                    and collaborate on crew sheets and faction relationships.
                  </p>
                </CardContent>
              </Card>
            </div>
